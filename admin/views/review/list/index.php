    ...
    <table class="min-w-full bg-white border border-gray-300">
        <thead>
            <tr>
                ...
                <th class="py-2 px-4 text-center border-b">Room</th>
                <th class="py-2 px-4 text-center border-b">Customer Reviews</th>
                <th class="py-2 px-4 text-center border-b">Content</th>
        ...
        <tbody>
            <?php foreach ($reviews as $review): ?>
                <tr>
                    ...
                    <td class="py-2 px-4 text-center border-b"><?php echo htmlspecialchars($review['user_name'] ?? 'Không xác định'); ?></td>
                    <td class="py-2 px-4 text-center border-b"><?php echo htmlspecialchars($review['room_description'] ?? 'Không xác định'); ?></td>
                    <td class="py-2 px-4 text-center border-b"><?php echo $review['rating']; ?></td>
                    <td class="py-2 px-4 text-center border-b"><?php echo htmlspecialchars($review['comment'] ?? 'Không có nhận xét'); ?></td>
                    <td class="py-2 px-4 text-center border-b"><?php echo date('d/m/Y', strtotime($review['review_date'])); ?></td>
