...
<div class="bg-light-blue py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-5xl mx-auto bg-white shadow-xl rounded-lg p-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            <div class="space-y-4">
                ...
                <p>
                    ...
                    <span class="font-bold text-<?php echo $booking['booking_status'] == 'confirmed' ? 'green' : 'red'; ?>-500">
            ...
            <div class="space-y-4">
                ...
                <p>
                    ...
                    <span class="font-bold text-<?php echo $booking['payment_status'] == 'completed' ? 'green' : 'red'; ?>-500">
        ...
        <!-- Room Information -->
        <div class="mb-8">
            <h3 class="text-2xl font-semibold text-second-blue mb-4">Room Details</h3>
        ...
        <div class="mt-8 text-center">
            <a href="home.php" 
                class="inline-block bg-primary-blue text-white text-lg font-semibold py-3 px-6 rounded-md 
