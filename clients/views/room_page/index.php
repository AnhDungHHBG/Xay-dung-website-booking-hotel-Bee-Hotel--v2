...
<div class="bg-gray-100 font-sans">
    <div class="container mx-auto p-6">
        ...
        <?php
        // Kiểm tra nếu cần hiển thị nút Load More
        if ($isLoadMoreDisabled) {
            if (isset($_GET['room_type_id'])) {
                ?>
                <a href="<?= $route->getLocateClient('filter-room', ['room_type_id' => $_GET['room_type_id'], 'limit' => $array_length + 10 ]) ?>">
                    <button class="px-6 py-2 bg-[#133E87] text-white rounded hover:bg-[#608BC1] transition-colors duration-300">
                        Load More...
                    </button>
                </a>
                <?php
            ...
            ?>
            <button class="px-6 py-2 bg-[#CBDCEB] text-white rounded cursor-not-allowed">
                Load More...
            </button>
            <?php
        }
