        ...
        <div class="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <div class="flex gap-5">
                <div class="relative mr-6">
                    <a href="<?= $route->getLocateClient('notification-list') ?>"
                ...
                <div class="relative">
                    ...
                    <div id="userMenu"
                        ...
                        <a href="<?= $route->getLocateAdmin('') ?> "
                            class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Admin Panel</a>
                        <?php endif; ?>
                        <a href="<?= $route->getLocateClient('signup') ?>"
                            class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Sign Up</a>
                        <a class="block px-4 py-2 text-gray-700 hover:bg-gray-100"
                            href="<?= $route->getLocateClient('profile') ?>">Profile</a>
                        <a href="#" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Help Center</a>
                        <a class="block px-4 py-2 text-gray-700 hover:bg-gray-100"
                            href="<?= $route->getLocateClient('logout') ?> ">Logout</a>
                    </div>
                    <?php
                    } else {
                        ?>
                    <div class="relative">
                        <div class="flex items-center gap-4">
                            <button class="userMenu" onclick="toggleUserMenu()"><i
                        ...
                        <div id="userMenu"
                            ...
                            <a href="<?= $route->getLocateClient('signup') ?>"
                                class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Sign Up</a>
                            <a class="block px-4 py-2 text-gray-700 hover:bg-gray-100"
                                href="<?= $route->getLocateClient('login') ?>">Login</a>
                            <a href="#" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Help Center</a>
                        </div>
                        <?php
                    }
